...
<table width="600" border="1" bgcolor="skyblue">
	<tr height="40">
		...
		<td width="180" align><%=bean.getWriter() %></td>
		<td width="120" align="center">작성일</td>
		<td width="180" align><%=bean.getReg_date() %></td>
	</tr>
	<tr height="40">
	...
	<tr height="40"> <!-- 패스워드가 기존글의 패스워드와 맞는지 기존글에 대한 정보가 필요하기때문에 hidden으로 넘버값을 넘겨줌 -->
		<td colspan="4" align="center">
		<input type="hidden" name="num" value="<%=bean.getNum() %>">
		<input type="submit" value="글수정"> &nbsp;&nbsp;
		<input type="button" onclick="location.href='BoardList.jsp'" value="전체결과보기"></td>	
	</tr>
